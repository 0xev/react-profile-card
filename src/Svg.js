    ...
    >
      <defs>
        <linearGradient id="c" x1="50%" x2="50%" y1=".779%" y2="100%">
          <stop offset="0%" stopColor="#0989B4" stopOpacity="0"></stop>
          <stop offset="99.94%" stopColor="#53FFEE"></stop>
        </linearGradient>
        <linearGradient id="d" x1="50%" x2="50%" y1=".779%" y2="100%">
          <stop offset="0%" stopColor="#0989B4" stopOpacity="0"></stop>
          <stop offset="99.94%" stopColor="#53FFEE"></stop>
        </linearGradient>
        <path id="a" d="M0 0h350v140H0z"></path>
      </defs>
      <g fill="none" fillRule="evenodd">
        <mask id="b" fill="#fff">
          <use xlinkHref="#a"></use>
        </mask>
        <use fill="#41CBD3" xlinkHref="#a"></use>
